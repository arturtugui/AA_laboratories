package lab_3.Mains.MainsDirected;
...
public class MainDirectedComplete {
    public static void main(String[] args) {
        String category = "Directed complete graphs";
        ...
        for (int i = 0; i < lines; i++) {
            int n = nValues[i];
            float mFloat = (float) n * (n-1);
            int m = (int) mFloat;

            graphs[i] = DirectedUndirectedGraphGenerator.generateStringLabelGraph(n, m, true);
        }
