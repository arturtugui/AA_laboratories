package lab_3.Mains.MainsKRegular;
...
import static lab_3.BFS.BFSVisualizer.visualizeBFS;
import static lab_3.BFS.BreadthFirstSearch.bfsWithOutput;
import static lab_3.DFS.DFSVisualizationRunner.visualizeDFS;
import static lab_3.DFS.DepthFirstSearch.dfsWithOutput;

public class Main5Regular {
    public static void main(String[] args) {
        String category = "Undirected 5-regular graph";
        int k = 5;
        ...
        int functionNamesSpace = 20;
        int cellsSpace = 12;

        //ruleaza greu
        int[] nValues = {10, 100, 1000, 4000, 7000, 10000, 25000, 50000, 75000, 100000};
        ...
        for (int i = 0; i < lines; i++) {
            ...
            graphs[i] = KRegularGraphGenerator.generateStringLabelKRegularGraph(nValues[i], k);
        }
    ...
    public static void doAlgorithmsComparison(List<BiFunction<Graph<String>, String, Integer>> functions,
        ...
        System.out.printf("%" + functionNamesSpace + "s", "nValues/regularity");

        for (int i=0; i< nValues.length; i++) {
            System.out.printf("%" + cellsSpace + "s", (nValues[i] + "/" + 5));
        }
        System.out.println("\n");
