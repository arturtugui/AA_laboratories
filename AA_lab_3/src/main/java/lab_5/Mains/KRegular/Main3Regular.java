...
public class Main3Regular {
    public static void main(String[] args) {
        ...
        int[] nValues = {100, 500, 1000, 5000, 10000, 25000, 32500, 50000, 75000, 100000, 150000, 200000, 300000, 400000, 600000};
        //int[] nValues = {1000, 5000, 10000, 25000, 32500, 50000, 75000, 100000, 150000, 200000, 300000, 400000, 600000, 800000, 1000000};
