package lab_5.Mains.Undirected;
...
public class MainUndirectedSparse {
    public static void main(String[] args) {
        String category = "Undirected sparse graphs";
        ...
        int[] nValues = {30, 75, 150, 300, 400, 500, 600, 800, 1000, 1200, 1600, 2000, 2400}; //fast
        //int[] nValues = {30, 75, 150, 300, 400, 500, 600, 800, 1000, 1200, 1600, 2000, 2400, 3200, 4800, 6400}; //slow
        //System.out.println(nValues.length);

        //to show a graph
        //int[] nValues = {5, 10, 20, 40, 80, 160, 320, 640, 1280, 2560}; //runs fast
        //int[] nValues = {5, 10, 20, 40, 80, 160, 320, 640, 1280, 2560, 5120}; //runs slow
        ...
        do {
            ...
            switch (choice) {
                ...
                case 5:
                    ...
                    PrimAlgorithmVisualizer.visualizeUndirected(graph);
                    break;
                case 6:
